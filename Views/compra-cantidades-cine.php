...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-9">
      <h3 class="text-center mt-2">Cantidades por cine</h3>

      <?php 
        foreach($comprasList as $compra){
      ?>
        <div class="alert alert-primary text-center my-1" role="alert">
        <strong>Cine:</strong> <?php echo $compra->getCineNombre() ?> / <strong>Cantidad:</strong> <?php echo $compra->getCantidad() ?> entradas
        </div>
      <?php
        }
      ?>
