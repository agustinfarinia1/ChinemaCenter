...
<main class="min-vh-75 d-flex justify-content-center align-items-center">
    ...
    <div class="w-75">
        <div class="row">
            ...
            <div class="col-3">
                <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#newCine">Nuevo Cine</button>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header bg-dark" id="headingOne">
                        <div class="d-flex justify-content-between mb-0">
                            ...
                            <button class="btn btn-outline-primary" data-toggle="modal" data-target="#newSala<?php echo $cine->getId(); ?>">
                                Nueva sala
                            </button>
                            ...
                            <span>
                                <button class="btn btn-outline-warning" data-toggle="modal" data-target="#editCine<?php echo $cine->getId(); ?>">Editar</button>
                                <button class="btn btn-outline-danger" data-toggle="modal" data-target="#deleteCine<?php echo $cine->getId(); ?>">Eliminar</button>
                                ...
                                <div class="col-12">
                                    ...
                                    ?>
                                            <div class="d-flex justify-content-between align-items-center alert alert-info">
                                                <a class="btn btn-outline-primary" href="<?php echo  FRONT_ROOT . "Funcion/SetSala/" . $sala->getId() ?>">Nueva Funcion</a>
                                                <span>
                                                ...
                                                <span>
                                                    <button class="btn btn-outline-warning" data-toggle="modal" data-target="#editSala<?php echo $sala->getId(); ?>">Editar</button>
                                                    <button class="btn btn-outline-danger" data-toggle="modal" data-target="#deleteSala<?php echo $sala->getId(); ?>">Eliminar</button>
                                                </span>
                                            </div>
                                    <?php
